...
THAI_CONFIG = {
    ...
    'categories': {
        'การเมือง/ประวัติศาสตร์': ['การเมือง', 'ปกครอง', 'กลาง', 'อารยชน', 'เผ่า', 'ก๊ก', 'สงคราม', 'อำนาจ', 'ผู้นำ', 'นำ', 'ยอมรับ', 'สถาปนา', 'ดึง', 'กลุ่ม'],
        'สังคม/วัฒนธรรม': ['สังคม', 'วัฒนธรรม', 'ชาว', 'คน', 'ชุมชน', 'ประเพณี', 'หน่วย', 'ทาง', 'ลักษณะ'],
        'ภูมิศาสตร์/การขยาย': ['ยุโรป', 'ขยาย', 'ดินแดน', 'เดินทาง', 'ที่ตั้ง', 'สามารถ', 'ให้'],
        'ความขัดแย้ง/สงคราม': ['สงคราม', 'ระหว่าง', 'ลบ', 'กัน', 'เสีย', 'ขึ้น', 'แก่', 'ต่าง'],
        'การศึกษา/ความรู้': ['เรียน', 'ศึกษา', 'รู้', 'เข้าใจ', 'วิชา', 'หนังสือ', 'ความรู้'],
        'อื่นๆ': []
    }
}
